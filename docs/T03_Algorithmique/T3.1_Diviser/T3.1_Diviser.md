...
??? check "Proposition de correction"
    ...
    class Labyrinthe:
        ...
        def construire_grille(self, h, l):
            grille = [[Cellule(True, True, True, True) for k in range(l)] for k in range(h)]
            return grille
    ...
    # Constantes
    hauteur_laby, largeur_laby, cote_cellule = 10, 10, 50
    taille_ecran = (largeur_laby*cote_cellule, hauteur_laby*cote_cellule)
    
    ## Instanciation d'un labyrinthe et génération
    laby = Labyrinthe(hauteur_laby, largeur_laby)
    laby.creer_labyrinthe(0, 0, largeur_laby, hauteur_laby)
