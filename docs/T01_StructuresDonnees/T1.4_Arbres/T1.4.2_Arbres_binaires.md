...
!!! abstract "Vocabulaire"
    === "Arbre binaire"
        ...
        L'arbre est dit *complet* si tous les nœuds possèdent exactement deux fils (ce qui n'est pas le cas de l'arbre précédent, le nœud Y n'ayant qu'un fils gauche).
...
!!! example "{{ exercice() }}"
    ...
    === "Correction" 
        {{ correction(False, 
        "
        1. On obtiens les sous-arbres gauche et droit de l'arbre illustré à la question 2.
