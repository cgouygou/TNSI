...
!!! abstract "Processus"
    Un processus est identifié par un PID, numéro attribué à sa création par le système d'exploitation.
...
!!! example "Exercices Type BAC"
    ...
    [Énoncé 3 (ex. 2) :material-download:](../data/sujet_14.pdf){.center .md-button }
    </span>
